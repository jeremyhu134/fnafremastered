...
class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        if(localStorage.getItem("nightSix") == undefined){
            gameState.nightSix = false;
            localStorage.setItem("nightSix",gameState.nightSix);
        }
        else {
            gameState.nightSix = localStorage.getItem("nightSix");
        }
        if(localStorage.getItem("customNight") == undefined){
            gameState.customNight = false;
            localStorage.setItem("customNight",gameState.customNight);
        }
        else {
            gameState.nightSix = localStorage.getItem("customNight");
        }
